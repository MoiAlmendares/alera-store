...
const DEFAULT_PRODUCTS_LIST = [
  { id:1,  name:'Llavero Cubone',             category:'Llavero',   fandom:'Pokémon',       price:170, img:'assets/cubone-mochila.png',                     badge:'',               dark:false, active:true },
  { id:2,  name:'Llavero Cubone Glow',         category:'Llavero',   fandom:'Pokémon',       price:205, img:'assets/cubone.jpg',                             badge:'',               dark:true,  active:true },
  { id:3,  name:'Llavero Hornet',              category:'Llavero',   fandom:'Hollow Knight', price:170, img:'assets/llavero-hornet.jpg',                     badge:'',               dark:false, active:true },
  { id:4,  name:'Llavero Esqueleto Minecraft', category:'Llavero',   fandom:'Minecraft',     price:170, img:'assets/llavero-esqueleto-minecraft.jpg',        badge:'',               dark:false, active:true },
  { id:5,  name:'Llavero Mandalorian',         category:'Llavero',   fandom:'Star Wars',     price:170, img:'assets/llavero-mandalorian.jpg',                badge:'',               dark:false, active:true },
  { id:6,  name:'Llaveros Star Wars',          category:'Llavero',   fandom:'Star Wars',     price:170, img:'assets/llaveros-star-wars.jpg',                 badge:'',               dark:false, active:true },
  { id:7,  name:'Llaveros Sharingan',          category:'Llavero',   fandom:'Naruto',        price:170, img:'assets/llaveros-sharingan.jpg',                 badge:'',               dark:false, active:true },
  { id:8,  name:'Llavero Pokébola',            category:'Llavero',   fandom:'Pokémon',       price:170, img:'assets/llavero-pokebola.jpg',                   badge:'',               dark:false, active:true },
  { id:9,  name:'Llavero Batarang',            category:'Llavero',   fandom:'DC / Batman',   price:170, img:'assets/Batarang.jpg',                           badge:'✨ Nuevo',        dark:false, active:true },
  { id:10, name:'Lámpara Minecraft',           category:'Lámpara',   fandom:'Minecraft',     price:400, img:'assets/lampara-minecraft.jpg',                  badge:'🔥 Más vendido', dark:false, active:true },
  { id:11, name:'Lámpara Tanjiro Kamado',      category:'Lámpara',   fandom:'Demon Slayer',  price:400, img:'assets/lampara-tanjiro.jpg',                    badge:'',               dark:false, active:true },
  { id:12, name:'Máscara Darth Vader',         category:'Decoración',fandom:'Star Wars',     price:320, img:'assets/mascara-darth-vader.jpg',                badge:'',               dark:false, active:true },
  { id:13, name:'Máscara The Mandalorian',     category:'Decoración',fandom:'Star Wars',     price:320, img:'assets/mandalorian-deco-pared.jpg',             badge:'',               dark:false, active:true },
  { id:14, name:'TIE Fighter (pared)',          category:'Decoración',fandom:'Star Wars',     price:320, img:'assets/tie-fighter-deco-pared.jpg',             badge:'',               dark:false, active:true },
  { id:15, name:'Perritos Minecraft',          category:'Figura',    fandom:'Minecraft',     price:230, img:'assets/perritos-minecraft.jpg',                 badge:'',               dark:false, active:true },
  { id:16, name:'Máscara Obito Uchiha',        category:'Figura',    fandom:'Naruto',        price:290, img:'assets/Obito.jpg',                              badge:'',               dark:false, active:true },
  { id:17, name:'TIE Fighter armable',         category:'Figura',    fandom:'Star Wars',     price:370, img:'assets/tie-fighter-armable.jpg',                badge:'',               dark:false, active:true },
  { id:18, name:'AT-ST Star Wars',             category:'Figura',    fandom:'Star Wars',     price:370, img:'assets/at-st-star-wars.jpg',                    badge:'✨ Nuevo',        dark:false, active:true },
